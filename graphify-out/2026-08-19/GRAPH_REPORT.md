...
## Corpus Check
- 78 files · ~95,290 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 407 nodes · 549 edges · 36 communities (29 shown, 7 thin omitted)
...
Cohesion: 0.11
Nodes (19): autoprefixer, @next/bundle-analyzer, devDependencies, autoprefixer, @next/bundle-analyzer, playwright, postcss, tailwindcss (+11 more)

### Community 3 - "layout.tsx"
Cohesion: 0.15
Nodes (7): inter, organizationSchema, spaceGrotesk, Grain(), Intro(), INSTAGRAM_URL, SITE_URL
...
Cohesion: 0.07
Nodes (20): NotFound(), PrototypeItem, RateCardBundle, RateCardCategory, RateCardLineItem, RateCardPage(), Footer(), Header() (+12 more)

### Community 35 - "package.json"
Cohesion: 0.13
Nodes (14): browserslist, name, private, scripts, build, dev, lint, start (+6 more)
...
## Knowledge Gaps
- **183 isolated node(s):** `mdxComponents`, `PageParams`, `organizationSchema`, `spaceGrotesk`, `inter` (+178 more)
...
- **Why does `routing` connect `articles/[slug]/page.tsx` to `rate-card/page.tsx`, `layout.tsx`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `buildWhatsAppHref()` connect `rate-card/page.tsx` to `[locale]/page.tsx`, `Hero.tsx`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Header()` connect `rate-card/page.tsx` to `articles/[slug]/page.tsx`, `[locale]/page.tsx`?**
